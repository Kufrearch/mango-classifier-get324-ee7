...
ETIM, DAVID EMMANUEL - Proposed standardizing all training and test images to a 224x224 RGB resolution to match MobileNetV2 input requirements.
...
USORO, UBONGABASI ISONGUYO - Suggested adding a clear UI disclaimer/warning banner to inform users that the app is strictly built for mango images.
...
NSIKAN, SAVIOUR EBENEZER - Verified the repository file arrangement to ensure .devcontainer, app.py, mango_classifier.h5, and requirements.txt were structured correctly.
